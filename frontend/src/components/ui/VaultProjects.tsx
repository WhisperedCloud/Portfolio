...
const projects = [
    {
        ...
        tags: ["TYPESCRIPT", "POSTGRESQL", "SUPABASE", "GEMINI API"],
    ...
    },
    {
    ...
    },
     {
        category: "WEB APP",
        title: "Leave Flow",
        desc: "Full-stack leave approval and management system with RBAC and multi-level workflows.",
        tags: ["REACT", "TYPESCRIPT", "NODE.JS", "EXPRESS", "MONGODB"],
        link: "https://github.com/WhisperedCloud/Leave.git",
        year: "2025"
    },
    {
        ...
        <section id="projects" className="w-full bg-[#f4f4f4] border-b-2 border-black font-sans py-32 px-6 md:px-12">
            ...
            <div className="flex flex-col md:flex-row justify-between items-end border-b-4 border-black pb-8 mb-16 max-w-[2000px] mx-auto">
                ...
                <div className="flex gap-8 mt-12 md:mt-0 text-right">
                    <div className="flex flex-col items-end border-r-2 border-black pr-8">
                        <h3 className="text-5xl font-black text-black tracking-tighter font-(family-name:--font-playfair)">07</h3>
                        <p className="text-[9px] font-bold tracking-[0.2em] text-black uppercase mt-1">Total</p>
                    </div>
                    <div className="flex flex-col items-end border-r-2 border-black pr-8">
                        <h3 className="text-5xl font-black text-black tracking-tighter font-(family-name:--font-playfair)">05</h3>
                        <p className="text-[9px] font-bold tracking-[0.2em] text-black uppercase mt-1">AI Powered</p>
                    </div>
                    <div className="flex flex-col items-end">
                        <h3 className="text-5xl font-black text-black tracking-tighter font-(family-name:--font-playfair)">04</h3>
                ...
                {projects.map((project, idx) => (
                    ...
                    >
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-16 w-full md:w-auto">
                            ...
                            <div>
                                <h3 className="text-3xl md:text-5xl font-black text-black group-hover:text-white tracking-tighter uppercase font-(family-name:--font-playfair) mb-2 group-hover:translate-x-4 transition-transform">
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center gap-8 mt-8 md:mt-0 w-full md:w-auto justify-between md:justify-end">
                            <div className="flex flex-wrap gap-2 max-w-62.5">
                            ...
                            <div className="flex items-center gap-6">
                                <span className="text-black group-hover:text-white text-lg font-bold font-(family-name:--font-playfair)">
                                    {project.year}
                                </span>
                                <a 
                                    href={project.link}
            ...
            <div className="w-full flex justify-center mt-16">
                <button className="px-12 py-6 bg-transparent border-2 border-black text-black text-xs font-bold tracking-[0.3em] uppercase hover:bg-black hover:text-white transition-colors">
                   Will be Loaded with More Projects
                </button>
            </div>
